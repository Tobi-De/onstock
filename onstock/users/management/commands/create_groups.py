...
from onstock.products.models import Product, Stock
from onstock.sales.models import Sale, Item as SaleItem
from onstock.purchases.models import Purchase, Item as PurchaseItem
